...
#ifdef CONFIG_FIH_TOUCHSCREEN_CYTTSP_I2C_TMA340
/*#define CY_I2C_IRQ_GPIO	  86*/ /*FIH-SW3-PERIPHERAL-CH-MES-02++*/
...
/* center: x: back: 53, menu: 160, home: 267, y: 523 SHIFT for moving down 14 points away  TOUCH AA */
				return sprintf(buf,
                        __stringify(EV_KEY) ":" __stringify(KEY_BACK)  ":53:523:53:58"
                   ":" __stringify(EV_KEY) ":" __stringify(KEY_HOME)   ":160:523:53:58"
                   ":" __stringify(EV_KEY) ":" __stringify(KEY_MENU)   ":267:523:53:58"
                   "\n");
/*FIH-MTD-PERIPHERAL-CH-KEY_AREA-00++]*/
}
/*FIH-MTD-PERIPHERAL-CH-Key_area-00++]*/
...
/*FIH-MTD-PERIPHERAL-CH-2016-00+[*/
	int ret =0;
	ret = gpio_tlmm_config(touch_config_gpio[2], GPIO_CFG_ENABLE);/*FIH-SW3-PERIPHERAL-CH-TAP-02++*/
	if (ret)
	{
		printk(KERN_ERR "%s: Failed to gpio_tlmm_config %d\n",
		       __func__, CY_I2C_IRQ_GPIO);
...
static struct cyttsp_platform_data cypress_i2c_ttsp_platform_data = {
...
#endif
#ifdef SECOND_MODULE
	.module_1 = "J-TOUCH",/*FIH-MTD-PERIPHERAL-CH-Add_command-00*/
	...
	.name = CY_I2C_NAME,
	.irq_gpio = 86,/*MSM_GPIO_TO_INT(CY_I2C_IRQ_GPIO),FIH-SW3-PERIPHERAL-CH-MES-02++*/ //ISR Number
	.row_pins_number = 16, /*FIH-MTD-PERIPHERAL-CH-AREA_JUDGE-00++*/	
	.col_pins_number = 10, /*FIH-MTD-PERIPHERAL-CH-AREA_JUDGE-00++*/	
};
#endif
/* SW1D3-Peripheral-OH-Cypress(TMA340)_TouchDriver_Porting-00+} */
/*FIH-SW3-PERIPHERAL-CH-TouchDriver_Porting_2010-00+]*/
...
static struct msm_camera_sensor_info msm_camera_sensor_s5k5cag_data = {
	...
	.vreg_v2p8        	= 94, /* FIH-SW3-MM-SL-ModifyGPIODefine-01* */ /* FIH-SW3-MM-SL-ModifyGPIODefine-00+ */
...
static struct msm_gpio uart3_gpios[] = {
	{GPIO_CFG(111, 2, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA),
							"uart3_tx"    },
	{GPIO_CFG(112, 2, GPIO_CFG_INPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA),
							"uart3_rx"    },
};
...
/* FIH-SW3-KERNEL-PK-Battery_Gauge_Porting-00*] */
	...
	gpio_tlmm_config( GPIO_CFG( 128, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA ), GPIO_CFG_ENABLE );
	...
	platform_device_register( &fih_device_headset); /* FIH-SW2-MM-AY-TAP_headset_00 */
