...
/*FIH-SW2-PERIPHERAL-AH-TouchDriver_Porting-00+[*/
#ifdef CONFIG_FIH_TOUCHSCREEN_CYTTSP_I2C_TMA340
...
#define GPIO_LCM_BKL_EN 109  /* FIH-SW2-MM-NC-BKL_EN-00 */
#endif
/* FIH-SW-MM-VH-DISPLAY-12*] */
...
{
	return DSI_TWO_LANES;  /* FIH-SW2-MM-NC-MIPI_TWO_LANE-00 */
}
/* FIH-SW-MM-VH-MES-00*] */
...
/* FIH-SW-MM-VH-DISPLAY-12*[ */
#ifdef CONFIG_FIH_SW_DISPLAY_DSI_BKL_EN
static int mipi_dsi_panel_bkl_en(int on)
{
	int rc = 0;
	...
	if (on) {
		rc = gpio_direction_output(GPIO_LCM_BKL_EN, 1);
	} else {
		rc = gpio_direction_output(GPIO_LCM_BKL_EN, 0);
	}

	if(rc < 0) {
		pr_err("[DISPLAY] %s: Failed to control lcm bkl enable\n", __func__);
	}
...
/* FIH-SW-MM-VH-DISPLAY-12*[ */
#ifdef CONFIG_FIH_SW_DISPLAY_DSI_BKL_EN
	.dsi_bkl_en = NULL,  /* FIH-SW2-MM-NC-LCM_INIT-00 */
#endif
/* FIH-SW-MM-VH-DISPLAY-12*] */
};
#endif
...
/* FIH-SW2-MM-NC-LCM_INIT-00-[+ */
	...
	if(fih_get_product_phase() < Phase_SP2) {
		mipi_dsi_pdata.dsi_bkl_en = mipi_dsi_panel_bkl_en;
	}
#endif
/* FIH-SW2-MM-NC-LCM_INIT-00-]- */
